    ...
    return (      
            <footer>
                <div className="text-white bg-[var(--color-primary-dark)]">
                    ...
                    <div className="py-6">
                        <div aria-hidden="true" className="flex overflow-hidden justify-between items-center text-[17vw] text-center tracking-tighter leading-none">
                            <div className="flex-1">Oh!</div>
                            <div className="flex-1">Oh!</div>
                            <div className="flex-1">Oh!</div>
                            <div className="flex-1 text-transparent [-webkit-text-stroke:1px_white]">Oh!</div>
                        </div>
                        <div className="flex justify-between items-center px-6 text-[clamp(1rem,0.95rem+0.25vw,1.25rem)]">
                            <p>©2025 Oh! YeongRong</p>
                            <a href="mailto:dhdudfhd920@gmailcom" className="hidden sm:block">
