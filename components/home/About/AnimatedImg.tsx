...
const WORK_IMAGES_DATA = [
    { 
        ...
        alt: "첫 번째 디자인 작업물", 
        aspect: "aspect-[3/2]",
        span: "col-span-1 md:col-span-3 sm:col-span-2", 
    ...
    { 
        ...
        alt: "세 번째 디자인 작업물", 
        aspect: "aspect-[3/2]", 
        span: "col-span-1 md:col-span-4 sm:col-span-3", 
...
export default function AnimatedImg() {
    ...
    return (
            <div 
                ref={workImgGridRef}
                className="w-full h-full grid grid-cols-1 sm:grid-cols-6 md:grid-cols-8 lg:grid-cols-12 gap-y-1 sm:gap-y-24 md:gap-y-32 lg:gap-y-48 sm:pb-32"
            >
                {
